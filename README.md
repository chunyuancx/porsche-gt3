...
- Bright white projector cores and cool optical bloom hold for 2.35 seconds, then fade over 0.7 seconds. The four-point daytime running lights stay on. After the 3.2-second intro and a brief 0.12-second pause, the interface fades in gently over 2.2 seconds against the same dark background. Skip intro and Escape exit immediately at the final car size; Replay headlights restarts the approach.
